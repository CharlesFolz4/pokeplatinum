...
static void ov19_021D4F40(const PCBoxes *pcBoxes, UnkStruct_ov19_021D4F5C *param1)
{
    param1->unk_01 = sub_02079AA8(pcBoxes, param1->unk_00);
    CopyBoxName(pcBoxes, param1->unk_00, param1->unk_04);
}
