...
static MiningObject sMiningObjects[] = {
    ...
    { .itemID = MINING_SMALL_RED_SPHERE, .oddTIDWeight = 150, .evenTIDWeight = 150, .oddTIDNatDexWeight = 110, .evenTIDNatDexWeight = 164, .width = 2 * 2, .height = 2 * 2, .shape = NULL, .spriteNARCIndex = small_red_sphere_NCGR, .paletteNARCIndex = red_sphere_NCLR },
    { .itemID = MINING_SMALL_BLUE_SPHERE, .oddTIDWeight = 150, .evenTIDWeight = 150, .oddTIDNatDexWeight = 150, .evenTIDNatDexWeight = 124, .width = 2 * 2, .height = 2 * 2, .shape = NULL, .spriteNARCIndex = small_blue_sphere_NCGR, .paletteNARCIndex = blue_sphere_NCLR },
    ...
    { .itemID = MINING_LARGE_RED_SPHERE, .oddTIDWeight = 80, .evenTIDWeight = 90, .oddTIDNatDexWeight = 61, .evenTIDNatDexWeight = 75, .width = 3 * 2, .height = 3 * 2, .shape = NULL, .spriteNARCIndex = large_red_sphere_NCGR, .paletteNARCIndex = red_sphere_NCLR },
    { .itemID = MINING_LARGE_BLUE_SPHERE, .oddTIDWeight = 90, .evenTIDWeight = 80, .oddTIDNatDexWeight = 75, .evenTIDNatDexWeight = 61, .width = 3 * 2, .height = 3 * 2, .shape = NULL, .spriteNARCIndex = large_blue_sphere_NCGR, .paletteNARCIndex = blue_sphere_NCLR },
    ...
    { .itemID = MINING_TREASURE_OVAL_STONE, .oddTIDWeight = 1, .evenTIDWeight = 1, .oddTIDNatDexWeight = 1, .evenTIDNatDexWeight = 1, .width = 3 * 2, .height = 3 * 2, .shape = NULL, .spriteNARCIndex = oval_stone_NCGR, .paletteNARCIndex = oval_stone_NCLR },
    { .itemID = MINING_TREASURE_ODD_KEYSTONE, .oddTIDWeight = 1, .evenTIDWeight = 1, .oddTIDNatDexWeight = 2, .evenTIDNatDexWeight = 2, .width = 4 * 2, .height = 4 * 2, .shape = NULL, .spriteNARCIndex = odd_keystone_NCGR, .paletteNARCIndex = odd_keystone_NCLR },
    ...
    { .itemID = MINING_TREASURE_DOME_FOSSIL, .oddTIDWeight = 3, .evenTIDWeight = 3, .oddTIDNatDexWeight = 3, .evenTIDNatDexWeight = 3, .width = 5 * 2, .height = 4 * 2, .shape = sDomeFossilShape, .spriteNARCIndex = dome_fossil_NCGR, .paletteNARCIndex = fossil_NCLR },
    ...
    { .itemID = MINING_TREASURE_OLD_AMBER, .oddTIDWeight = 3, .evenTIDWeight = 3, .oddTIDNatDexWeight = 3, .evenTIDNatDexWeight = 3, .width = 4 * 2, .height = 4 * 2, .shape = sOldAmberShape, .spriteNARCIndex = old_amber_NCGR, .paletteNARCIndex = old_amber_NCLR },
    { .itemID = MINING_TREASURE_OLD_AMBER, .oddTIDWeight = 3, .evenTIDWeight = 3, .oddTIDNatDexWeight = 3, .evenTIDNatDexWeight = 3, .width = 4 * 2, .height = 4 * 2, .shape = sOldAmberShape90deg, .spriteNARCIndex = old_amber_90deg_NCGR, .paletteNARCIndex = old_amber_NCLR },
    ...
    { .itemID = MINING_TREASURE_ARMOR_FOSSIL, .oddTIDWeight = 25, .evenTIDWeight = 25, .oddTIDNatDexWeight = 12, .evenTIDNatDexWeight = 12, .width = 5 * 2, .height = 4 * 2, .shape = sArmorFossilShape, .spriteNARCIndex = armor_fossil_NCGR, .paletteNARCIndex = fossil_NCLR },
    { .itemID = MINING_TREASURE_SKULL_FOSSIL, .oddTIDWeight = 25, .evenTIDWeight = 25, .oddTIDNatDexWeight = 12, .evenTIDNatDexWeight = 12, .width = 4 * 2, .height = 4 * 2, .shape = sSkullFossilShape, .spriteNARCIndex = skull_fossil_NCGR, .paletteNARCIndex = fossil_NCLR },
